...
pf.async = pf.asyncTest();
pf.isNWJS = typeof nw === 'object';
pf.isNodeJS = typeof window != 'object';

if(pf.isNodeJS && !pf.async && pf.isNWJS){
